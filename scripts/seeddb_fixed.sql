...
-- Requires CSVs in /tmp directory: tmdb_5000_movies.csv and tmdb_5000_credits.csv
-- Recommended run:
-- sudo -u postgres psql -d movie_rating_db -f /tmp/seeddb_fixed.sql
-- ===============================
...
ALTER TABLE movie_ratings ADD COLUMN IF NOT EXISTS rated_at TIMESTAMP;
