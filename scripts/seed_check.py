...
DATABASE_URL = "postgresql://postgres:10203151000m@localhost:5432/movie_rating_db"
    ...
    try:
        with Session(engine) as session:
            ...
            if movie_count == 1000 and director_count > 1000:
                ...
                print(
                    f"Seeding Failed. Expected 1000 movies, found {movie_count} movies and {director_count} director."
                )
                return False

    except Exception as e:
        print(
            f"Database connection or query failed during verification: {e}"
        )
        return False
